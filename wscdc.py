...
"M�dulo para utilizar el servicio web Constataci�n de Comprobantes de AFIP"
...
# No deber�a ser necesario modificar nada despues de esta linea

# definici�n del formato del archivo de intercambio (s�lo para linea de comandos):

ENCABEZADO = [
    ('tipo_reg', 1, A, "0: encabezado"),
    ('cbte_modo', 4, A, "Modalidad de autorizaci�n (CAI, CAE, CAEA)"),
    ...
    ('cbte_nro', 8, N, "N�mero de comprobante"),
    ('cbte_fch', 8, A, "Fecha en formato AAAAMMDD"),
    ('imp_total', 15, I, "Importe total Double (13 + 2)"),
    ('cod_autorizacion', 14, A, "N�mero de CAI, CAE, CAEA"),
...
OBSERVACION = [
    ...
    ('code', 5, N, "C�digo de Observaci�n / Error / Evento"),
    ('msg', 255, A, "Mensaje"),
]
...
class WSCDC(BaseWS):
    "Interfaz para el WebService de Constataci�n de Comprobantes"
    ...
    def Dummy(self):
        "M�todo Dummy para verificaci�n de funcionamiento de infraestructura"
    ...
    def ConstatarComprobante(self, cbte_modo, cuit_emisor, pto_vta, cbte_tipo,
                             ...
                             **kwargs):
        "M�todo de Constataci�n de Comprobantes"
    ...
    def ConsultarModalidadComprobantes(self, sep="|"):
        "Recuperador de modalidades de autorizaci�n de comprobantes"
...
def main():
    ...
    if '--formato' in sys.argv:
        ...
        for msg, formato in [('Encabezado', ENCABEZADO),
            ...
            print("|| %-20s || %8s || %9s || %-12s || %-20s ||" % (
                "Campo", "Posici�n", "Longitud", "Tipo", "Descripci�n"))
            for fmt in formato:
    ...
    # leo configuraci�n de archivos de intercambio
